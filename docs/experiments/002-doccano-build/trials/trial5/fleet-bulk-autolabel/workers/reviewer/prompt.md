...
## Code Repository
/home/sagar/doccano-fork/worktrees/trial5-bulk-autolabel
...
### Trial 4
- Iterations dir: `/home/sagar/doccano-fork/docs/experiments/002-doccano-build/trials/trial4/fleet-bulk-autolabel/iterations/`
  Read prior `review-*.md` files to see what previous reviewers flagged.
  Read `completion-report.md` if it exists for the final state.
...
| Task | Status | Notes |
|------|--------|-------|
| Task 6: Bulk Auto-Label Button | PASS/FAIL | {one line} |
...
## Output Directory
/home/sagar/doccano-fork/docs/experiments/002-doccano-build/trials/trial5/fleet-bulk-autolabel/iterations
